var NotificationTableManaged = function () {

    var markReadNotification = function (table, tbRow, id) {
        $.ajax({
    ...
    var initTable = function (table) {
        ...
        table.on('click', '.btn-mark', function () {
            ...
            var data = row.data();
            markReadNotification(table, row, data["Id"]);
        });
    }
...
if (App.isAngularJsApp() === false) { 
    jQuery(document).ready(function() {
        ...
        NotificationTableManaged.init(table);
    });
}
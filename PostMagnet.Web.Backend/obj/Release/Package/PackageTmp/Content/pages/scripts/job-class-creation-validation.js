var JobClassButtonClicks = function () {
    var handleButtonClicks = function (cancelButton) {

        cancelButton.on("click", function (e) {
            window.location.assign("/jobclass/index");
        });
    };
...
var FormValidation = function () {
    ...
    var handleCreateJobClassValidation = function () {
        ...
        form.validate({
            ...
            submitHandler: function(form) {
                ...
                $.post(formAddJobClassAction, $.param(model), function (data) {
    ...
    return {
        ...
        init: function () {
            handleCreateJobClassValidation();
        }
    };
}();
...
jQuery(document).ready(function () {
    FormValidation.init();
    JobClassButtonClicks.init($("#job-class-cancel"));
});
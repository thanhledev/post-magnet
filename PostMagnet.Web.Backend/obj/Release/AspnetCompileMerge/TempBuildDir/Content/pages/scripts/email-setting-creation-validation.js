var EmailSettingButtonClicks = function() {
    var handleButtonClicks = function(cancelButton) {

        cancelButton.on("click", function(e) {
            window.location.assign("/emailsetting/index");
        });
    };
...
var FormValidation = function () {
    ...
    var handleCreateEmailSettingValidation = function () {
        ...
        form.validate({
            ...
            submitHandler: function(form) {
                ...
                $.post(formAddEmailSettingAction, $.param(model), function (data) {
    ...
    return {
        ...
        init: function () {
            handleCreateEmailSettingValidation();
        }
    };
}();
...
jQuery(document).ready(function () {
    FormValidation.init();
    EmailSettingButtonClicks.init($("#email-setting-cancel"));
});
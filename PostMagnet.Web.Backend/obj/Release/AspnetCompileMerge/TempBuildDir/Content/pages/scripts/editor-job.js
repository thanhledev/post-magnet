var EditorJob = function () {

    return {

        //main function
        init: function () {
            EditorJob.initNotific8();
            EditorJob.initSwitch();
            EditorJob.initButtons();
            EditorJob.initSelect2();
            EditorJob.initDateRange();
            EditorJob.initTypeahead();
        },
